...
public class EllipseShape extends GeometricShapes 
{
  ...
  public void draw(final Graphics the_g) 
  {
    ...
    the_g.drawOval(x, y, w, h);
  }
  /**
   *  @param the_g is parameter for graphics.
   *  @param the_x1 is x1 coordinate..
   *  @param the_x2 is x2 coordinate..
   *  @param the_y1 is y1 coordinate.
   *  @param the_y2 is y2 coordinate.
   */
